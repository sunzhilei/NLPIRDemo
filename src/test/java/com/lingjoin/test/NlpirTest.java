...
public class NlpirTest {
	...
	public void testNewWords(){
		...
		System.out.println("===============================文本新词(有时文本太短，没有新词)");
		System.out.println(result);
	}
	...
	public void testFileNewWords(){
		...
		System.out.println("===============================文本路径新词(有时文本太短，没有新词)");
		System.out.println(result);
	}
